...
const uint8_t PROGMEM Env1[] = {
  255, //255,  //242,  229,  216,    //  3
  253, //204,  //191,  178,  165,    //  7
  252, //153,  //142,  134,  125,    //  11
  249, //117,  //108,  100,  91,     //  15
  246, //83,   //74,   71,   68,     //  19
  232, //65,   //62,   59,   56,     //  23
  215, //53,   //50,   48,   46,     //  27
  195, //44,   //42,   40,   38,     //  31  == 1/4
  120, //36,   //34,   32,   31,     //  35
  60,  //30,   //29,   28,   28,     //  39
  27,   //26,   25,   25,     //  43
  24,   //24,   23,   23,     //  47
...
const uint8_t PROGMEM Env2[] = {
  255, //255,  //254,  254,  254,    //  3
  253, //253,  //253,  253,  252,    //  7
  252, //252,  //252,  251,  251,    //  11
  249, //251,  //250,  250,  250,    //  15
  246, //249,  //249,  247,  244,    //  19
  232, //242,  //240,  237,  235,    //  23
  215, //233,  //230,  219,  200,    //  27
  195, //180,  //160,  141,  121,    //  31  == 1/4
  110, //102,  //82,   62,   58,     //  35
  53,   //49,   45,   40,     //  39
  36,   //31,   27,   25,     //  43
  24,   //24,   23,   23,     //  47
...
const uint8_t PROGMEM Env3[] = {
  255, //255,  //250,  246,  242,    //  3
  253, //238,  //233,  229,  225,    //  7
  252, //221,  //217,  213,  209,    //  11
  249, //206,  //202,  199,  195,    //  15
  246, //191,  //188,  183,  179,    //  19
  232, //175,  //170,  166,  161,    //  23
  215, //157,  //153,  148,  144,    //  27
  195, //139,  //134,  130,  125,    //  31  == 1/4
  160, //121,  //116,  112,  109,    //  35
  120, //105,  //102,  99,   96,     //  39
  100, //93,   //90,   87,   83,     //  43
  80,   //77,   74,   71,     //  47
  68,   //65,   61,   58,     //  51
  56,   //54,   51,   49,     //  55
