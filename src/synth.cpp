...
unsigned char synth::synthTick(void)
{
  if(tik)
  {
    tik=0;
...
unsigned char synth::voiceFree(unsigned char voice)
{
...
void synth::setTime(unsigned char voice,float t)
{
